	...
	<body>
		...
		<form action="signup.do" name="signupForm" method="get">
			<table>
				...
				<tr>
					<td colspan="2"><input type="text" name="user_id" size="41" ></td>
				</tr>
				<tr>
					<td>비밀번호 재확인</td>
				</tr>
				...
				<tr>
					<td><input type="text" name="user_id" size="30" placeholder="ex) 01066030058"> <input type="button" size="20" value="중복확인"></td>
				</tr>
				<tr>
					<td>주소</td>
				</tr>
			...
			<input type="button" name="btnSubmit" onclick="test()">
		</form>
		</div>
	</body>
</html>